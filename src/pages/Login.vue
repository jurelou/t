<template>
  <div class="flex justify-center items-center" style="height: 100%">
    ...
    <login-panel v-model:username="loginData.username" v-model:password="loginData.password" :loading="false"
...
//     message.value = loginResponse.value;
//   }
// });
